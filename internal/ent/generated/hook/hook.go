...
type DatabaseFunc func(context.Context, *generated.DatabaseMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f DatabaseFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.DatabaseMutation); ok {
		return f(ctx, mv)
	}
