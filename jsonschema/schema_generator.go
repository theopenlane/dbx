...
import (
	...
	"github.com/theopenlane/dbx/config"
	"github.com/theopenlane/dbx/jsonschema/envparse"
)

// const values used for the schema generator
const (
	repoName       = "github.com/theopenlane/dbx/"
	tagName        = "koanf"
	skipper        = "-"
	defaultTag     = "default"
	jsonSchemaPath = "./jsonschema/dbx.config.json"
